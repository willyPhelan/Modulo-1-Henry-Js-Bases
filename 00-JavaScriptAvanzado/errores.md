...
* __Errores Semánticos__: Se dan por el mal uso de algún _Statement_ del lenguaje.
...
* __Errores en tiempo de Compilación__: Aparecen cuando nuestro código es parseado por un compilador o intérprete. 
...
Para hacer esto en JavaScrip vamos a usar el statement: `try` y `catch`:
